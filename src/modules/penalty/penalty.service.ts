...
export class PenaltyService {
  ...
  async penaltyCreate(req: any, body: any): Promise<response<Penalty>> {
    try {
      const { penalty_name, penalty, workers } = body;
  ...
  async penaltyUpdate(
    ...
    req: any,
    body: any,
  ): Promise<response<Penalty>> {
    try {
      const { penalty, penalty_name } = body;
